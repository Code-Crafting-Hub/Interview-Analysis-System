  ...
  return (
    <div className="bg-[#B3E5FC]">
      ...
      <section className="flex flex-col h-screen justify-center">
        <p className="text-[#0C0CF7] font-semibold text-center text-[3rem]">
          HR SOLUTION
        </p>
        <p className="text-[#0C0CF7] font-semibold text-center text-[1.5rem] md:text-[1.8rem]">
          For Modern HR Professionals
        </p>
        <p className="text-[#6164FF] text-center text-[2rem] md:text-[3.5rem] font-semibold">
